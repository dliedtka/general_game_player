...
function bestmove(role, state, library){
	...
	// prepare alpha-beta pruning
	var alpha = 0;
	var beta = 100;

	// find minimax score if we make current move
	var result = minscore(role, actions[i], state, library, alpha, beta);
...
function minscore(role, action, state, library, alpha, beta){
    // get opponent's role
	...
	// find minimax score if opponent makes current move
	var result = maxscore(role, newstate, library, alpha, beta);
...
function maxscore(role, state, library, alpha, beta){
    ...
    for (var i = 0; i < actions.length; i++){
	// minimax score if we make current move
	var result = minscore(role, actions[i], state, library, alpha, beta);
